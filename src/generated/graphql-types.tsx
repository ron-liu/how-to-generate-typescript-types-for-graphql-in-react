...
export type GetAllPeopleQuery = (
  ...
  & { allPeople?: Maybe<(
    ...
    & { people?: Maybe<Array<Maybe<(
      { __typename?: 'Person' }
      & Pick<Person, 'name' | 'birthYear' | 'gender' | 'height'>
    )>>> }
  )> }
);
...
export function useGetAllPeopleQuery(baseOptions?: Apollo.QueryHookOptions<GetAllPeopleQuery, GetAllPeopleQueryVariables>) {
        return Apollo.useQuery<GetAllPeopleQuery, GetAllPeopleQueryVariables>(GetAllPeopleDocument, baseOptions);
      }
export function useGetAllPeopleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllPeopleQuery, GetAllPeopleQueryVariables>) {
          return Apollo.useLazyQuery<GetAllPeopleQuery, GetAllPeopleQueryVariables>(GetAllPeopleDocument, baseOptions);
        }
